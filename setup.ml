...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2a8b70354bc1583970a4516e3f030af1) *)
(*
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "ocaml-ketama is consistent hashing library written in ocaml";
          description = None;
          categories = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/camlunity/ocaml-ketama.git";
                      src_repo_browser =
                        Some "https://github.com/ocaml-ketama/cobson";
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "ketama"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
